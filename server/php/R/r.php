        ...
        if ($r_resource_type == 'json') {
            ...
            case 'GET':
                if (in_array('read', $scope)) {
                    ...
                    header($_SERVER['SERVER_PROTOCOL'] . ' 401 Authentication failed1', true, 401);
                }
                break;
            ...
            case 'POST':
                if (((!empty($scope) && in_array('write', $scope)) || in_array($r_resource_cmd, $scope_exception_url)) && ((!empty($authUser)) || (in_array($r_resource_cmd, $exception_url) && empty($authUser)))) {
                    ...
                    header($_SERVER['SERVER_PROTOCOL'] . ' 401 Authentication failed2', true, 401);
                }
                break;
            ...
            case 'PUT':
                if ((in_array('write', $scope)) && ((!empty($authUser)) || (in_array($r_resource_cmd, $exception_url) && empty($authUser)))) {
                    ...
                    header($_SERVER['SERVER_PROTOCOL'] . ' 401 Authentication failed3', true, 401);
                }
                break;
            ...
            case 'DELETE':
                if ((in_array('write', $scope)) && ((!empty($authUser)) || (in_array($r_resource_cmd, $exception_url) && empty($authUser)))) {
                    ...
                    header($_SERVER['SERVER_PROTOCOL'] . ' 401 Authentication failed4', true, 401);
                }
                break;
